...
import {createRemittance, updateRemittance} from "../../data";
...
export function FormContent({ updateTools }) {
  ...
  const onUpdateRemittance = async () => {
    ...
    try {
      ...
      if (senderNameError==="" && senderBankError==="" && senderAccountError==="" && receiverNameError==="" && receiverBankError==="" && receiverAccountError==="" && amountError==="") {
        ...
        await updateRemittance(token, id, senderName, senderBank, senderAccount, receiverName, receiverBank, receiverAccount, amount);
        ...
        <Form
            actions={
              <SpaceBetween direction="horizontal" size="xs">
                ...
                <Button onClick={onUpdateRemittance} variant="primary">Update remittance</Button>
              </SpaceBetween>
            }
            errorText={""}
...
export default UpdateRemittanceForm;