...
import {createRemittance} from "../../data";
...
export function FormContent({ updateTools }) {
  ...
  const onCreateRemittance = async () => {
    ...
    try {
      ...
      if (senderNameError==="" && senderBankError==="" && senderAccountError==="" && receiverNameError==="" && receiverBankError==="" && receiverAccountError==="" && amountError==="") {
        ...
        await createRemittance(token, senderName, senderBank, senderAccount, receiverName, receiverBank, receiverAccount, amount);
...
export default CreateRemittanceForm;